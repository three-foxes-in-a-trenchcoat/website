...
export default function RootLayout() {
  ...
  const handleCommand = (cmd: string) => {
    ...
    // Commands with arguments that need special handling
    if (base === "figlet" || base === "banner") {
      const fn = EASTER_EGGS.figlet;
    ...
    if (lower === "help") {
      setHistory((h) => [
        ...
        "  System:      neofetch, whoami, uname, hostname, uptime, top, htop, ps, free, df",
        "  Network:     ping, curl, wget",
        "  Dev tools:   git, docker, kubectl",
        "  Tools:       note, guestbook, theme, history, man, echo, date",
      ...
      >
        ...
        <div className="flex flex-col items-center min-h-screen">
          ...
          >
            ...
            {/* Terminal */}
            <div
              className="p-6 whitespace-pre-wrap break-words font-mono text-base min-h-[60vh]"
